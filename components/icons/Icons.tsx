...
export const WaterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path fillRule="evenodd" d="M5.166 7.614c0036 0 .071.026.082.07a8.19 8.19 0 013.51 6.52c0 4.418-3.582 8-8 8s-8-3.582-8-8a8.19 8.19 0 013.51-6.52c.01-.044.046-.07.082-.07.036 0 .071.026.082.07a8.23 8.23 0 001.643 2.655 8.23 8.23 0 001.643-2.655c.011-.044.046-.07.082-.07z" clipRule="evenodd" opacity="0" />
         <path d="M12 2.25c-5.385 5.385-8.25 9.135-8.25 12.75 0 4.556 3.694 8.25 8.25 8.25s8.25-3.694 8.25-8.25C20.25 11.385 17.385 7.635 12 2.25z" />
    </svg>
);
...
export const PlusSmallIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" {...props}>
